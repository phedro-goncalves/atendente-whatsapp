...
# 👉 Carrega base de conhecimento local
with open('respostas.json', 'r', encoding='utf-8') as f:
    BASE_CONHECIMENTO = json.load(f)

# 👉 Busca resposta com base na palavra-chave
...
def webhook():
    ...
    mensagem_dict = dados.get('texto', {})
    print("📎 Campo 'texto':", mensagem_dict, flush=True)

    mensagem_recebida = mensagem_dict.get('mensagem', '')
